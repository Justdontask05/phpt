        ...
        if(!empty($_POST)) {
            ...
            switch($_POST['type']) {
                ...
                case 'paypal':
                    ...
                    $settings['paypal_email'] = $_POST['paypal_email'] = mb_substr(trim(Database::clean_string($_POST['paypal_email'])), 0, $qr_code_settings['type']['paypal']['email']['max_length']);
                    $settings['paypal_title'] = $_POST['paypal_title'] = mb_substr(trim(Database::clean_string($_POST['paypal_title'])), 0, $qr_code_settings['type']['paypal']['title']['max_length']);
                    $settings['paypal_currency'] = $_POST['paypal_currency'] = mb_substr(trim(Database::clean_string($_POST['paypal_currency'])), 0, $qr_code_settings['type']['paypal']['currency']['max_length']);
                    $settings['paypal_price'] = $_POST['paypal_price'] = (float) $_POST['paypal_price'];
                    $settings['paypal_thank_you_url'] = $_POST['paypal_thank_you_url'] = mb_substr(trim(Database::clean_string($_POST['paypal_thank_you_url'])), 0, $qr_code_settings['type']['paypal']['thank_you_url']['max_length']);
                    $settings['paypal_cancel_url'] = $_POST['paypal_cancel_url'] = mb_substr(trim(Database::clean_string($_POST['paypal_cancel_url'])), 0, $qr_code_settings['type']['paypal']['cancel_url']['max_length']);
                    break;
            }
