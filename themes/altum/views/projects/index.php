...
<section class="container">
    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-xl-auto d-flex">
            ...
            <?php else: ?>
                <button type="button" data-toggle="modal" data-target="#create_project_modal" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> <?= language()->projects->create ?></button>
            <?php endif ?>
            </div>
                        ...
                        <form action="" method="get" role="form">
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="search_by" id="filters_search_by" class="form-control form-control-sm">
                                    <option value="name" <?= $data->filters->search_by == 'name' ? 'selected="selected"' : null ?>><?= language()->projects->input->name ?></option>
                                </select>
                            </div>
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="order_by" id="filters_order_by" class="form-control form-control-sm">
                                    ...
                                    <option value="name" <?= $data->filters->order_by == 'name' ? 'selected="selected"' : null ?>><?= language()->projects->table->name ?></option>
                                </select>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="#" data-toggle="modal" data-target="#project_update_modal" data-project-id="<?= $row->project_id ?>" data-name="<?= $row->name ?>" data-color="<?= $row->color ?>" class="dropdown-item"><i class="fa fa-fw fa-pencil-alt"></i> <?= language()->global->edit ?></a>
                            <a href="#" data-toggle="modal" data-target="#project_delete_modal" data-project-id="<?= $row->project_id ?>" class="dropdown-item"><i class="fa fa-fw fa-times"></i> <?= language()->global->delete ?></a>
                        </div>
                    </div>
                </div>
                </div>
