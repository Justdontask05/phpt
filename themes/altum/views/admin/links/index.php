                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="search_by" id="filters_search_by" class="form-control form-control-sm">
                                ...
                                <option value="location_url" <?= $data->filters->search_by == 'location_url' ? 'selected="selected"' : null ?>><?= language()->admin_links->filters->search_by_location_url ?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="form-control form-control-sm">
                                ...
                                <option value="location_url" <?= $data->filters->order_by == 'location_url' ? 'selected="selected"' : null ?>><?= language()->admin_links->filters->order_by_location_url ?></option>
    ...
    <table class="table table-custom">
        ...
        <?php foreach($data->links as $row): ?>
            ...
            <tr>
                    ...
                    <div class="d-flex flex-column">
                        <div>
                            ...
                            <?php if($row->type == 'biolink' && $row->is_verified): ?>
                                <span data-toggle="tooltip" title="<?= language()->link->biolink->verified ?>"><i class="fa fa-fw fa-xs fa-check-circle link-verified" style="color: #3897F0"></i></span>
                            <?php endif ?>
                        </div>
                ...
                <td>
                    <?= include_view(THEME_PATH . 'views/admin/links/admin_link_dropdown_button.php', ['id' => $row->link_id, 'is_verified' => $row->is_verified, 'type' => $row->type]) ?>
                </td>
            </tr>
        <?php endforeach ?>
        </tbody>
