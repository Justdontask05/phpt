                    ...
                    <div class="card-body">
                        ...
                        <form name="update_biolink" action="" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= language()->link->settings->url ?></label>
                            ...
                            <div class="form-group">
                                <label for="settings_background_type"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= language()->link->settings->background_type ?></label>
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-fw fa-image fa-sm text-muted mr-1"></i> <?= language()->link->settings->favicon ?></label>
                            ...
                            <div <?= $this->user->plan_settings->leap_link ? null : 'data-toggle="tooltip" title="' . language()->global->info_message->plan_feature_no_access . '"' ?>>
                                <div class="<?= $this->user->plan_settings->leap_link ? null : 'container-disabled' ?>">
                                    <div class="form-group">
                                        <label for="leap_link"><i class="fa fa-fw fa-forward fa-sm text-muted mr-1"></i> <?= language()->link->settings->leap_link ?></label>
                            ...
                            <div class="collapse" id="verified_container">
                                ...
                                <div class="alert alert-info">
                                    <i class="fa fa-fw fa-info-circle mr-1"></i> <?= language()->link->settings->verified_help ?>
                                </div>
                                <?php endif ?>

                                <div <?= $data->link->is_verified ? null : 'data-toggle="tooltip" title="' . language()->global->info_message->plan_feature_no_access . '"' ?>>
                            ...
                            <div class="collapse" id="branding_container">
                                ...
                                <div <?= $this->user->plan_settings->custom_branding ? null : 'data-toggle="tooltip" title="' . language()->global->info_message->plan_feature_no_access . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->custom_branding ? null : 'container-disabled' ?>">
                                        <div class="form-group">
                                            <label for="branding_name"><i class="fa fa-fw fa-random fa-sm text-muted mr-1"></i> <?= language()->link->settings->branding->name ?></label>
                                        ...
                                        <div class="form-group">
                                            <label for="branding_url"><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= language()->link->settings->branding->url ?></label>
                                ...
                                <div class="form-group">
                                    <label for="settings_text_color"><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= language()->link->settings->text_color ?></label>
                            ...
                            <div class="collapse" id="seo_container">
                                <div <?= $this->user->plan_settings->seo ? null : 'data-toggle="tooltip" title="' . language()->global->info_message->plan_feature_no_access . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->seo ? null : 'container-disabled' ?>">
                                        ...
                                        <div class="form-group">
                                            <label for="seo_title"><i class="fa fa-fw fa-heading fa-sm text-muted mr-1"></i> <?= language()->link->settings->seo_title ?></label>
                                        ...
                                        <div class="form-group">
                                            <label for="seo_meta_description"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->link->settings->seo_meta_description ?></label>
                                        ...
                                        <div class="form-group">
                                            <label><i class="fa fa-fw fa-image fa-sm text-muted mr-1"></i> <?= language()->link->settings->seo_image ?></label>
                            ...
                            <div class="collapse" id="fonts_container">
                                <div <?= $this->user->plan_settings->fonts ? null : 'data-toggle="tooltip" title="' . language()->global->info_message->plan_feature_no_access . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->fonts ? null : 'container-disabled' ?>">
                                        ...
                                        <div class="form-group">
                                            <label for="settings_font"><i class="fa fa-fw fa-pen-nib fa-sm text-muted mr-1"></i> <?= language()->link->settings->font ?></label>
                                        ...
                                        <div class="form-group">
                                            <label for="settings_font_size"><i class="fa fa-fw fa-font fa-sm text-muted mr-1"></i> <?= language()->link->settings->font_size ?></label>
                                            <div class="input-group">
                            ...
                            <div class="collapse" id="protection_container">
                                ...
                                <div <?= $this->user->plan_settings->password ? null : 'data-toggle="tooltip" title="' . language()->global->info_message->plan_feature_no_access . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->password ? null : 'container-disabled' ?>">
                                        <div class="form-group">
                                            <label for="qweasdzxc"><i class="fa fa-fw fa-key fa-sm text-muted mr-1"></i> <?= language()->link->settings->password ?></label>
