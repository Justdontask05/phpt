...
<form name="update_biolink_" method="post" role="form">
    ...
    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'mail_settings_container_' . $row->biolink_block_id ?>" aria-expanded="false" aria-controls="<?= 'mail_settings_container_' . $row->biolink_block_id ?>">
        <?= language()->create_biolink_mail_modal->mail_header ?>
    </button>
    ...
    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'mail_data_container_' . $row->biolink_block_id ?>" aria-expanded="false" aria-controls="<?= 'mail_data_container_' . $row->biolink_block_id ?>">
        <?= language()->create_biolink_mail_modal->data_header ?>
    </button>

    <div class="collapse" id="<?= 'mail_data_container_' . $row->biolink_block_id ?>">
        <p class="text-muted"><?= sprintf(language()->create_biolink_mail_modal->data_help, '<a href="' . url('data') . '" target="_blank">', '</a>') ?></p>
        <div class="form-group">
    ...
    <div class="form-group">
        <label for="<?= 'mail_name_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->name ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'mail_image_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-image fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->image ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'mail_icon_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-globe fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->icon ?></label>
    ...
    <div <?= $this->user->plan_settings->custom_colored_links ? null : 'data-toggle="tooltip" title="' . language()->global->info_message->plan_feature_no_access . '"' ?>>
        <div class="<?= $this->user->plan_settings->custom_colored_links ? null : 'container-disabled' ?>">
            <div class="form-group">
                <label for="<?= 'mail_text_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->text_color ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'mail_background_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->background_color ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'mail_border_width_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-border-style fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->border_width ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'mail_border_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->border_color ?></label>
