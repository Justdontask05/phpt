            ...
            <div class="modal-body">
                <form name="create_biolink_cta" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="cta_type"><i class="fa fa-fw fa-comments fa-sm text-muted mr-1"></i> <?= language()->create_biolink_cta_modal->type ?></label>
                    ...
                    <div class="form-group">
                        <label for="cta_name"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->name ?></label>
