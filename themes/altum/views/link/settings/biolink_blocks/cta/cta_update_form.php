...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'cta_type_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-comments fa-sm text-muted mr-1"></i> <?= language()->create_biolink_cta_modal->type ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'cta_value_' . $row->biolink_block_id ?>">
            <span data-cta-type="email" class="d-none"><i class="fa fa-fw fa-envelope fa-sm text-muted mr-1"></i> <?= language()->create_biolink_cta_modal->value_email ?></span>
            <span data-cta-type="call" class="d-none"><i class="fa fa-fw fa-phone-square-alt fa-sm text-muted mr-1"></i> <?= language()->create_biolink_cta_modal->value_call ?></span>
            <span data-cta-type="sms" class="d-none"><i class="fa fa-fw fa-sms fa-sm text-muted mr-1"></i> <?= language()->create_biolink_cta_modal->value_sms ?></span>
            <span data-cta-type="facetime" class="d-none"><i class="fa fa-fw fa-headset fa-sm text-muted mr-1"></i> <?= language()->create_biolink_cta_modal->value_facetime ?></span>
        </label>
    ...
    <div class="form-group">
        <label for="<?= 'cta_name_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->name ?></label>
        ...
        <div <?= $this->user->plan_settings->temporary_url_is_enabled ? null : 'data-toggle="tooltip" title="' . language()->global->info_message->plan_feature_no_access . '"' ?>>
            <div class="<?= $this->user->plan_settings->temporary_url_is_enabled ? null : 'container-disabled' ?>">
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label for="<?= 'cta_start_date_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-clock fa-sm text-muted mr-1"></i> <?= language()->link->settings->start_date ?></label>
                            <input
                    ...
                    <div class="col">
                        <div class="form-group">
                            <label for="<?= 'cta_end_date_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-clock fa-sm text-muted mr-1"></i> <?= language()->link->settings->end_date ?></label>
                            <input
    ...
    <div class="form-group">
        <label for="<?= 'cta_image_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-image fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->image ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'cta_icon_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-globe fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->icon ?></label>
    ...
    <div <?= $this->user->plan_settings->custom_colored_links ? null : 'data-toggle="tooltip" title="' . language()->global->info_message->plan_feature_no_access . '"' ?>>
        <div class="<?= $this->user->plan_settings->custom_colored_links ? null : 'container-disabled' ?>">
            <div class="form-group">
                <label for="<?= 'cta_text_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->text_color ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'cta_background_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->background_color ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'cta_border_width_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-border-style fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->border_width ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'cta_border_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->border_color ?></label>
