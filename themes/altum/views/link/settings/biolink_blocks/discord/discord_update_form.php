...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'discord_server_id_' . $row->biolink_block_id ?>"><i class="fab fa-fw fa-discord fa-sm text-muted mr-1"></i> <?= language()->create_biolink_discord_modal->server_id ?></label>
