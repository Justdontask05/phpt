...
<form name="update_biolink_" method="post" role="form">
    ...
    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'vcard_settings_container_' . $row->biolink_block_id ?>" aria-expanded="false" aria-controls="<?= 'vcard_settings_container_' . $row->biolink_block_id ?>">
        <?= language()->create_biolink_vcard_modal->vcard_header ?>
    </button>
    ...
    <div class="collapse" id="<?= 'vcard_settings_container_' . $row->biolink_block_id ?>">
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    <label for="<?= 'vcard_first_name_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_first_name ?></label>
            ...
            <div class="col-6">
                <div class="form-group">
                    <label for="<?= 'vcard_last_name_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_last_name ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_phone_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-phone-square-alt fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_phone ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_email_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-envelope fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_email ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_url_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_url ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_company_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-building fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_company ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_job_title_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-user-tie fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_job_title ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_birthday_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-birthday-cake fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_birthday ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_street_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-road fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_street ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_city_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-city fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_city ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_zip_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-mail-bulk fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_zip ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_region_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-flag fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_region ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_country_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-globe fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_country ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_note_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->create_biolink_vcard_modal->vcard_note ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'vcard_name_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->name ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'vcard_image_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-image fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->image ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'vcard_icon_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-globe fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->icon ?></label>
    ...
    <div <?= $this->user->plan_settings->custom_colored_links ? null : 'data-toggle="tooltip" title="' . language()->global->info_message->plan_feature_no_access . '"' ?>>
        <div class="<?= $this->user->plan_settings->custom_colored_links ? null : 'container-disabled' ?>">
            <div class="form-group">
                <label for="<?= 'vcard_text_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->text_color ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'vcard_background_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->background_color ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'vcard_border_width_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-border-style fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->border_width ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'vcard_border_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->border_color ?></label>
