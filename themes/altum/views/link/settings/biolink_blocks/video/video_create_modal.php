            ...
            <div class="modal-body">
                <form name="create_biolink_video" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="video_file"><i class="fa fa-fw fa-video fa-sm text-muted mr-1"></i> <?= language()->create_biolink_video_modal->file ?></label>
                    ...
                    <div class="form-group">
                        <label for="video_name"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->name ?></label>
