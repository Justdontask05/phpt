...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'facebook_url_' . $row->biolink_block_id ?>"><i class="fab fa-fw fa-facebook fa-sm text-muted mr-1"></i> <?= language()->create_biolink_facebook_modal->location_url ?></label>
