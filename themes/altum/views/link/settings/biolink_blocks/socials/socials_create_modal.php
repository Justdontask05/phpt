            ...
            <div class="modal-body">
                <form name="create_biolink_socials" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="socials_color"><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= language()->create_biolink_socials_modal->color ?></label>
                    ...
                    <?php foreach($biolink_socials as $key => $value): ?>
                        <?php if($value['input_group']): ?>
                            <div class="form-group">
                                <label for="<?= 'socials_' . $key ?>"><i class="<?= $value['icon'] ?> fa-fw fa-sm text-muted mr-1"></i> <?= language()->create_biolink_socials_modal->socials->{$key}->name ?></label>
