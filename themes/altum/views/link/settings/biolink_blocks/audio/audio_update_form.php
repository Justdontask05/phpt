...
<form name="update_biolink_" method="post" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="<?= 'audio_file_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-volume-up fa-sm text-muted mr-1"></i> <?= language()->create_biolink_audio_modal->file ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'audio_name_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->name ?></label>
