            ...
            <div class="modal-body">
                <form name="create_biolink_file" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="file_file"><i class="fa fa-fw fa-file fa-sm text-muted mr-1"></i> <?= language()->create_biolink_file_modal->file ?></label>
                    ...
                    <div class="form-group">
                        <label for="file_name"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->name ?></label>
