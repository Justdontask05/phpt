...
<form name="update_biolink_" method="post" role="form">
    ...
    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'phone_collector_settings_container_' . $row->biolink_block_id ?>" aria-expanded="false" aria-controls="<?= 'phone_collector_settings_container_' . $row->biolink_block_id ?>">
        <?= language()->create_biolink_phone_collector_modal->phone_collector_header ?>
    </button>

    <div class="collapse" id="<?= 'phone_collector_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'phone_collector_phone_placeholder_' . $row->biolink_block_id ?>"><?= language()->create_biolink_phone_collector_modal->phone_placeholder ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'phone_collector_name_placeholder_' . $row->biolink_block_id ?>"><?= language()->create_biolink_phone_collector_modal->name_placeholder ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'phone_collector_button_text_' . $row->biolink_block_id ?>"><?= language()->create_biolink_phone_collector_modal->button_text ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'phone_collector_success_text_' . $row->biolink_block_id ?>"><?= language()->create_biolink_phone_collector_modal->success_text ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'phone_collector_thank_you_url_' . $row->biolink_block_id ?>"><?= language()->create_biolink_phone_collector_modal->thank_you_url ?></label>
        ...
        <div class="custom-control custom-switch mr-3 mb-3">
            ...
            >
            <label class="custom-control-label clickable" for="<?= 'phone_collector_show_agreement_' . $row->biolink_block_id ?>"><?= language()->create_biolink_phone_collector_modal->show_agreement ?></label>
            <div><small class="form-text text-muted"><?= language()->create_biolink_phone_collector_modal->show_agreement_help ?></small></div>
        </div>

        <div class="form-group">
            <label for="<?= 'phone_collector_agreement_text_' . $row->biolink_block_id ?>"><?= language()->create_biolink_phone_collector_modal->agreement_text ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'phone_collector_agreement_url_' . $row->biolink_block_id ?>"><?= language()->create_biolink_phone_collector_modal->agreement_url ?></label>
    ...
    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'phone_collector_data_container_' . $row->biolink_block_id ?>" aria-expanded="false" aria-controls="<?= 'phone_collector_data_container_' . $row->biolink_block_id ?>">
        <?= language()->create_biolink_phone_collector_modal->data_header ?>
    </button>

    <div class="collapse" id="<?= 'phone_collector_data_container_' . $row->biolink_block_id ?>">
        <p class="text-muted"><?= sprintf(language()->create_biolink_phone_collector_modal->data_help, '<a href="' . url('data') . '" target="_blank">', '</a>') ?></p>

        <div class="form-group">
            <label for="<?= 'phone_collector_webhook_url_' . $row->biolink_block_id ?>"><?= language()->create_biolink_phone_collector_modal->webhook_url ?></label>
            ...
            <small class="form-text text-muted"><?= language()->create_biolink_phone_collector_modal->webhook_url_help ?></small>
        </div>
    </div>

    <div class="form-group">
        <label for="<?= 'phone_collector_name_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->name ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'phone_collector_image_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-image fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->image ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'phone_collector_icon_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-globe fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->icon ?></label>
        <input id="<?= 'phone_collector_icon_' . $row->biolink_block_id ?>" type="text" name="icon" class="form-control" value="<?= $row->settings->icon ?>" placeholder="<?= language()->create_biolink_link_modal->input->icon_placeholder ?>" />
    ...
    <div <?= $this->user->plan_settings->custom_colored_links ? null : 'data-toggle="tooltip" title="' . language()->global->info_message->plan_feature_no_access . '"' ?>>
        <div class="<?= $this->user->plan_settings->custom_colored_links ? null : 'container-disabled' ?>">
            <div class="form-group">
                <label for="<?= 'phone_collector_text_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->text_color ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'phone_collector_background_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->background_color ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'phone_collector_border_width_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-border-style fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->border_width ?></label>
                <input id="<?= 'phone_collector_border_width_' . $row->biolink_block_id ?>" type="number" min="0" max="5" class="form-control" name="border_width" value="<?= $row->settings->border_width ?>" required="required" />
            </div>

            <div class="form-group">
                <label for="<?= 'phone_collector_border_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->border_color ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'phone_collector_border_radius_' . $row->biolink_block_id ?>"><?= language()->create_biolink_link_modal->input->border_radius ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'phone_collector_border_style_' . $row->biolink_block_id ?>"><?= language()->create_biolink_link_modal->input->border_style ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'phone_collector_animation_' . $row->biolink_block_id ?>"><?= language()->create_biolink_link_modal->input->animation ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'phone_collector_animation_runs_' . $row->biolink_block_id ?>"><?= language()->create_biolink_link_modal->input->animation_runs ?></label>
