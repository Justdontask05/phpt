    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= language()->create_biolink_phone_collector_modal->header ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="<?= language()->global->close ?>">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <p class="text-muted modal-subheader"><?= language()->create_biolink_phone_collector_modal->subheader ?></p>
            ...
            <div class="modal-body">
                <form name="create_biolink_phone_collector" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="phone_collector_name"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->name ?></label>
