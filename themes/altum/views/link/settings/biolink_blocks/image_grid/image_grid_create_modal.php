            ...
            <div class="modal-body">
                <form name="create_biolink_image_grid" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="image_grid_name"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->name ?></label>
                        <input id="image_grid_name" type="text" name="name" class="form-control" />
                    </div>

                    <div class="form-group">
                        <label for="image_grid_image"><i class="fa fa-fw fa-image fa-sm text-muted mr-1"></i> <?= language()->create_biolink_image_grid_modal->image ?></label>
                        <input id="image_grid_image" type="file" name="image" accept=".gif, .png, .jpg, .jpeg, .svg" class="form-control-file" required="required" />
                    </div>

                    <div class="form-group">
                        <label for="image_grid_image_alt"><i class="fa fa-fw fa-comment-dots fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->image_alt ?></label>
                    ...
                    <div class="form-group">
                        <label for="image_grid_location_url"><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= language()->create_biolink_link_modal->input->location_url ?></label>
