                ...
                <div class="card-body">
                    <form action="" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="name"><i class="fa fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->name ?></label>
                        ...
                        <div class="form-group">
                            <label for="project_id">
                                <i class="fa fa-fw fa-project-diagram fa-sm text-muted mr-1"></i> <?= language()->projects->project_id ?>
                        ...
                        <div class="form-group">
                            <label for="type"><i class="fa fa-fw fa-qrcode fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->type ?></label>
                            <select id="type" name="type" class="form-control">
                                <?php foreach(array_keys($data->qr_code_settings['type']) as $type): ?>
                                    <option value="<?= $type ?>" <?= ($data->values['type'] ?? null) == $type ? 'selected="selected"' : null ?>><?= language()->qr_codes->type->{$type} ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        ...
                        <div>
                            <div class="form-group" data-type="text">
                                <label for="text"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->text ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="url">
                                <label for="url"><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->url ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="phone">
                                <label for="phone"><i class="fa fa-fw fa-phone-square-alt fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->phone ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="sms">
                                <label for="sms"><i class="fa fa-fw fa-sms fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->sms ?></label>
                            ...
                            <div class="form-group" data-type="sms">
                                <label for="sms_body"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->sms_body ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="email">
                                <label for="email"><i class="fa fa-fw fa-envelope fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->email ?></label>
                            ...
                            <div class="form-group" data-type="email">
                                <label for="email_subject"><i class="fa fa-fw fa-heading fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->email_subject ?></label>
                            ...
                            <div class="form-group" data-type="email">
                                <label for="email_body"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->email_body ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="whatsapp">
                                <label for="whatsapp"><i class="fab fa-fw fa-whatsapp fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->whatsapp ?></label>
                            ...
                            <div class="form-group" data-type="whatsapp">
                                <label for="whatsapp_body"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->whatsapp_body ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="facetime">
                                <label for="facetime"><i class="fa fa-fw fa-headset fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->facetime ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="location">
                                <label for="location_latitude"><i class="fa fa-fw fa-map-pin fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->location_latitude ?></label>
                            ...
                            <div class="form-group" data-type="location">
                                <label for="location_longitude"><i class="fa fa-fw fa-map-pin fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->location_longitude ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="wifi">
                                <label for="wifi_ssid"><i class="fa fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->wifi_ssid ?></label>
                            ...
                            <div class="form-group" data-type="wifi">
                                <label for="wifi_encryption"><i class="fa fa-fw fa-user-shield fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->wifi_encryption ?></label>
                            ...
                            <div class="form-group" data-type="wifi">
                                <label for="wifi_password"><i class="fa fa-fw fa-key fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->wifi_password ?></label>
                            ...
                            <div class="form-group" data-type="wifi">
                                <label for="wifi_is_hidden"><i class="fa fa-fw fa-user-secret fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->wifi_is_hidden ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="event">
                                <label for="event"><i class="fa fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->event ?></label>
                            ...
                            <div class="form-group" data-type="event">
                                <label for="event_location"><i class="fa fa-fw fa-map-pin fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->event_location ?></label>
                            ...
                            <div class="form-group" data-type="event">
                                <label for="event_url"><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->event_url ?></label>
                            ...
                            <div class="form-group" data-type="event">
                                <label for="event_note"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->event_note ?></label>
                            ...
                            <div class="form-group" data-type="event">
                                <label for="event_start_datetime"><i class="fa fa-fw fa-calendar fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->event_start_datetime ?></label>
                            ...
                            <div class="form-group" data-type="event">
                                <label for="event_end_datetime"><i class="fa fa-fw fa-calendar fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->event_end_datetime ?></label>
                            ...
                            <div class="form-group" data-type="event">
                                <label for="event_timezone"><i class="fa fa-fw fa-atlas fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->event_timezone ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="crypto">
                                <label for="crypto_coin"><i class="fab fa-fw fa-bitcoin fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->crypto_coin ?></label>
                            ...
                            <div class="form-group" data-type="crypto">
                                <label for="crypto_address"><i class="fa fa-fw fa-coins fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->crypto_address ?></label>
                        ...
                        <div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group" data-type="vcard">
                                        <label for="vcard_first_name"><i class="fa fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_first_name ?></label>
                                ...
                                <div class="col-6">
                                    <div class="form-group" data-type="vcard">
                                        <label for="vcard_last_name"><i class="fa fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_last_name ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_phone"><i class="fa fa-fw fa-phone-square-alt fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_phone ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_email"><i class="fa fa-fw fa-envelope fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_email ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_url"><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_url ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_company"><i class="fa fa-fw fa-building fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_company ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_job_title"><i class="fa fa-fw fa-user-tie fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_job_title ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_birthday"><i class="fa fa-fw fa-birthday-cake fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_birthday ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_street"><i class="fa fa-fw fa-road fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_street ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_city"><i class="fa fa-fw fa-city fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_city ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_zip"><i class="fa fa-fw fa-mail-bulk fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_zip ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_region"><i class="fa fa-fw fa-flag fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_region ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_country"><i class="fa fa-fw fa-globe fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_country ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_note"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->vcard_note ?></label>
                        ...
                        <div>
                            <div class="form-group" data-type="paypal">
                                <label for="paypal_type"><i class="fab fa-fw fa-paypal fa-sm mr-1"></i> <?= language()->qr_codes->input->paypal_type ?></label>
                                <select id="paypal_type" name="paypal_type" class="form-control" data-reload-qr-code>
                                    <?php foreach($data->qr_code_settings['type']['paypal']['type'] as $key => $value): ?>
                                        <option value="<?= $key ?>" <?= ($data->values['settings']['paypal_type'] ?? null) == $key ? 'selected="selected"' : null?>><?= language()->qr_codes->input->{'paypal_type_' . $key} ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>

                            <div class="form-group" data-type="paypal">
                                <label for="paypal_email"><i class="fa fa-fw fa-envelope fa-sm mr-1"></i> <?= language()->qr_codes->input->paypal_email ?></label>
                            ...
                            <div class="form-group" data-type="paypal">
                                <label for="paypal_title"><i class="fa fa-fw fa-heading fa-sm mr-1"></i> <?= language()->qr_codes->input->paypal_title ?></label>
                            ...
                            <div class="form-group" data-type="paypal">
                                <label for="paypal_currency"><i class="fa fa-fw fa-euro-sign fa-sm mr-1"></i> <?= language()->qr_codes->input->paypal_currency ?></label>
                            ...
                            <div class="form-group" data-type="paypal">
                                <label for="paypal_price"><i class="fa fa-fw fa-dollar-sign fa-sm mr-1"></i> <?= language()->qr_codes->input->paypal_price ?></label>
                            ...
                            <div class="form-group" data-type="paypal">
                                <label for="paypal_thank_you_url"><i class="fa fa-fw fa-link fa-sm mr-1"></i> <?= language()->qr_codes->input->paypal_thank_you_url ?></label>
                            ...
                            <div class="form-group" data-type="paypal">
                                <label for="paypal_cancel_url"><i class="fa fa-fw fa-link fa-sm mr-1"></i> <?= language()->qr_codes->input->paypal_cancel_url ?></label>
                        ...
                        <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#colors_container" aria-expanded="false" aria-controls="colors_container">
                            <i class="fa fa-fw fa-palette fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->colors ?>
                        </button>

                        <div class="collapse" id="colors_container">
                            <div class="form-group">
                                <label for="foreground_type"><i class="fa fa-fw fa-paint-roller fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->foreground_type ?></label>
                            ...
                            <div class="form-group" data-foreground-type="color">
                                <label for="foreground_color"><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->foreground_color ?></label>
                            ...
                            <div class="form-group" data-foreground-type="gradient">
                                <label for="foreground_gradient_style"><i class="fa fa-fw fa-brush fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->foreground_gradient_style ?></label>
                            ...
                            <div class="form-group">
                                <label for="custom_eyes_color"><i class="fa fa-fw fa-eye fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->custom_eyes_color ?></label>
                        ...
                        <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#branding_container" aria-expanded="false" aria-controls="branding_container">
                            <i class="fa fa-fw fa-copyright fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->branding ?>
                        </button>
                        ...
                        <div class="collapse" id="branding_container">
                            ...
                            <div class="form-group">
                                <label for="qr_code_logo_size"><i class="fa fa-fw fa-expand-alt fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->qr_code_logo_size ?></label>
                        ...
                        <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#options_container" aria-expanded="false" aria-controls="options_container">
                            <i class="fa fa-fw fa-wrench fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->options ?>
                        </button>

                        <div class="collapse" id="options_container">
                            <div class="form-group">
                                <label for="size"><i class="fa fa-fw fa-expand-arrows-alt fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->size ?></label>
                            ...
                            <div class="form-group">
                                <label for="margin"><i class="fa fa-fw fa-expand fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->margin ?></label>
                            ...
                            <div class="form-group">
                                <label for="ecc"><i class="fa fa-fw fa-check fa-sm text-muted mr-1"></i> <?= language()->qr_codes->input->ecc ?></label>
            ...
            <div class="row mb-4 d-print-none">
                ...
                <div class="col-12 col-lg-6 mb-3 mb-lg-0 dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="<?= $data->values['data'] ?? ASSETS_FULL_URL . 'images/qr_code.svg' ?>" id="download_svg" class="dropdown-item" download="<?= ($data->values['name'] ?? settings()->main->title) . '.svg' ?>"><?= language()->qr_codes->download_svg ?></a>
                        <button type="button" class="dropdown-item" onclick="convert_svg_to_others(null, 'png', '<?= ($data->values['name'] ?? settings()->main->title) . '.png' ?>');"><?= language()->qr_codes->download_png ?></button>
                        <button type="button" class="dropdown-item" onclick="convert_svg_to_others(null, 'jpg', '<?= ($data->values['name'] ?? settings()->main->title) . '.jpg' ?>');"><?= language()->qr_codes->download_jpg ?></button>
                        <button type="button" class="dropdown-item" onclick="convert_svg_to_others(null, 'webp', '<?= ($data->values['name'] ?? settings()->main->title) . '.webp' ?>');"><?= language()->qr_codes->download_webp ?></button>
                    </div>
                </div>
            </div>
