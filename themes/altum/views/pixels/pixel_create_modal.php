            ...
            <div class="modal-body">
                <form name="create_pixel" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="create_name"><i class="fa fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= language()->pixels->input->name ?></label>
                        <input type="text" id="create_name" class="form-control" name="name" required="required" />
                    </div>

                    <div class="form-group">
                        <label for="create_type"><i class="fa fa-fw fa-adjust fa-sm text-muted mr-1"></i> <?= language()->pixels->input->type ?></label>
                    ...
                    <div class="form-group">
                        <label for="create_pixel"><i class="fa fa-fw fa-code fa-sm text-muted mr-1"></i> <?= language()->pixels->input->pixel ?></label>
